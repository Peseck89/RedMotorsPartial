declare module "@salesforce/apex/CT_nuevaCita_controller.getKilometros" {
  export default function getKilometros(param: {cocheId: any, cocheVin: any, kilometros: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getActives" {
  export default function getActives(param: {recordId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getDataAsesor" {
  export default function getDataAsesor(param: {asesorId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getDataActivos" {
  export default function getDataActivos(param: {accountId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.guardarAsset" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.getCalendario" {
  export default function getCalendario(): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getDataCalendario" {
  export default function getDataCalendario(param: {calendarId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getAsesores" {
  export default function getAsesores(param: {calendario: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getCedula" {
  export default function getCedula(param: {cedula: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getSeguroDetails" {
  export default function getSeguroDetails(param: {cocheId: any, cocheVin: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getAsset" {
  export default function getAsset(param: {cocheId: any, cocheVin: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.updateDataAccount" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.updateAccount" {
  export default function updateAccount(param: {cocheId: any, cocheVin: any, cuentaId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.updateContactData" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.updateContact" {
  export default function updateContact(param: {cocheId: any, cocheVin: any, contactId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.actualizarHorarios" {
  export default function actualizarHorarios(param: {recordId: any, fecha: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.createContact" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.createAccount" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.otrosEventos" {
  export default function otrosEventos(param: {cocheId: any, cocheVin: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getDependentMap" {
  export default function getDependentMap(param: {controlField: any, depentField: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getServiceT" {
  export default function getServiceT(param: {calendarioSel: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.buscarDuplicado" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.createEvent" {
...
declare module "@salesforce/apex/CT_nuevaCita_controller.updateEventOrigen" {
  export default function updateEventOrigen(param: {idShadow: any, origenCorrecto: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getUrlEvent" {
  export default function getUrlEvent(param: {idShadow: any, esteRecord: any, origenCorrecto: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getCurrentUser" {
  export default function getCurrentUser(): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.verifyContactData" {
  export default function verifyContactData(param: {contactId: any, accountId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.getCampaniasByAssetId" {
  export default function getCampaniasByAssetId(param: {assetId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.confirmarCampanias" {
  export default function confirmarCampanias(param: {assetId: any}): Promise<any>;
}
declare module "@salesforce/apex/CT_nuevaCita_controller.obtenerDisponibilidadProximosDias" {
  export default function obtenerDisponibilidadProximosDias(): Promise<any>;
}
