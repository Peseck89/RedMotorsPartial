...
- **Cierre técnico conciliado de Sprint 2 (2026-08-13):** los 20 Flows autoritativos quedaron reconciliados sin duplicados. F07 y N2 están resueltos; N4 conserva un fallo de inicialización pendiente de diagnóstico después de aplicar FLS mínimo, y N3 espera confirmación de Diego. Sprint 2 permanece **NO CERRABLE** hasta resolver esos pendientes. Ver [`CIERRE_TECNICO_SPRINT2_20260813.md`](CIERRE_TECNICO_SPRINT2_20260813.md).
- **Actualización posterior a respuestas de Luis (2026-08-13):** F07, N2 y N4 quedaron autorizados con baselines Bavarian y datos provisionales claramente rotulados. F07 y N2 terminaron **QA FUNCIONAL OK — PEKING**; N2 completó las variantes normal v11 y selectiva v9 después de aplicar Read mínimo sobre `Empresa__c.Codigo_ERP__c`. En N4 se aplicó el FLS mínimo autorizado, pero v21 conserva un fallo de inicialización pendiente de diagnóstico y v55 no se ejecutó; N3 sigue pendiente de Diego. Ver [`CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md`](CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md).
