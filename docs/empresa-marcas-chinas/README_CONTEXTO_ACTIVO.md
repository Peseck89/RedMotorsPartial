...
- **Cierre técnico conciliado de Sprint 2 (2026-08-13):** los 20 Flows autoritativos quedaron reconciliados sin duplicados: 6 con QA funcional completo, 3 con validación técnica y QA diferido, 6 revisados sin cambio técnico, 3 bloqueados por decisiones de negocio y 2 no aplicables. F07 y N2 están resueltos; N4 conserva QA funcional pendiente y N3 espera confirmación de Diego. Sprint 2 permanece **NO CERRABLE** hasta resolver esos pendientes. Ver [`CIERRE_TECNICO_SPRINT2_20260813.md`](CIERRE_TECNICO_SPRINT2_20260813.md).
- **Actualización posterior a respuestas de Luis (2026-08-13):** F07, N2 y N4 quedaron autorizados con baselines Bavarian y datos provisionales claramente rotulados. F07 y N2 terminaron **QA FUNCIONAL OK — PEKING**; N2 completó las variantes normal v11 y selectiva v9 después de aplicar Read mínimo sobre `Empresa__c.Codigo_ERP__c`. N4 está desplegado técnicamente y conserva QA dirigido pendiente; N3 sigue pendiente de Diego. Ver [`CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md`](CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md).
