...
- **QA P0 — Flows de Opportunity y mano de obra (2026-08-13):** `Opp_flow_V3`, `Opp_Flow_v6` y `Opportunity_Flow_V2` conservan **QA de creación OK** y navegación remediada. Para mano de obra se desplegó en Partial el permiso mínimo `WorkOrder_Empresa_Factura_QA`, marcado **QA TEMPORAL — NO PROMOVER A PRODUCCIÓN**, y se preparó el dataset compartido. El insert de Expense ejecutó `CreateWoliFromExpense` v15, pero no creó WOLI: existen dos Product2 `SUB`, el lookup sin orden eligió uno sin PricebookEntry en `PEKING Local` y el Flow terminó por su salida controlada. Estado: **QA EJECUTADO — NO APROBADO**, sin fault ni rollback. `AgregarManoObra` no fue ejecutado. Ver [`RESULTADO_QA_REMEDIACION_OPP_FLOW_V3_20260812.md`](RESULTADO_QA_REMEDIACION_OPP_FLOW_V3_20260812.md), [`RESULTADO_REMEDIACION_OPP_FLOW_V6_20260812.md`](RESULTADO_REMEDIACION_OPP_FLOW_V6_20260812.md), [`RESULTADO_QA_REMEDIACION_OPPORTUNITY_FLOW_V2_20260812.md`](RESULTADO_QA_REMEDIACION_OPPORTUNITY_FLOW_V2_20260812.md) y [`RESULTADO_PREPARACION_QA_P0_20260812.md`](RESULTADO_PREPARACION_QA_P0_20260812.md).
