...
- **Actualización posterior a respuestas de Luis (2026-08-13):** F07, N2 y N4 quedaron autorizados con baselines Bavarian y datos provisionales claramente rotulados. N4 fue desplegado técnicamente (`aperturaCaseWorOrderEvent` v21 y `ct_newCaseWorkOrderEvent` v55); N2 quedó preparado. La única ejecución F07 v24 alcanzó la persistencia pero terminó en fault y rollback, GUID `8650ffa67691e21665d43c649a7719ffbfb9dd8-59d2`. No se ejecutaron N2/N4 después del fault. Estado vigente: **SPRINT 2 NO CERRABLE — F07 PENDIENTE DE DIAGNÓSTICO TÉCNICO CONCLUYENTE**; N3 sigue pendiente de Diego. Ver [`CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md`](CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md).
