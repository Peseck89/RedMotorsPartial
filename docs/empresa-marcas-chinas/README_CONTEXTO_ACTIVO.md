...
- **QA P0 — Flows de Opportunity (2026-08-12):** `Opp_flow_V3`, `Opp_Flow_v6` y `Opportunity_Flow_V2` crearon y conservaron Opportunity y Quote con PEKING, CRC y Pricebook `PEKING Local`; la creación queda en **QA OK**. Los tres componentes legacy de navegación fueron sustituidos de forma aislada por enlaces estándar; v30, v82 y v8 están activas respectivamente y queda pendiente validar cada enlace integrado durante una ejecución funcional normal. `PlanDeMantenimientoV2`, `CreateWoliFromExpense` y `AgregarManoObra` continúan esperando datos funcionales de entrada. Ver [`RESULTADO_QA_REMEDIACION_OPP_FLOW_V3_20260812.md`](RESULTADO_QA_REMEDIACION_OPP_FLOW_V3_20260812.md), [`RESULTADO_REMEDIACION_OPP_FLOW_V6_20260812.md`](RESULTADO_REMEDIACION_OPP_FLOW_V6_20260812.md), [`RESULTADO_QA_REMEDIACION_OPPORTUNITY_FLOW_V2_20260812.md`](RESULTADO_QA_REMEDIACION_OPPORTUNITY_FLOW_V2_20260812.md) y [`RESULTADO_PREPARACION_QA_P0_20260812.md`](RESULTADO_PREPARACION_QA_P0_20260812.md).
