...
- **Cierre técnico conciliado de Sprint 2 (2026-08-13):** los 20 Flows autoritativos quedaron reconciliados sin duplicados: 4 con QA funcional completo, 3 con validación técnica y QA diferido, 6 revisados sin cambio técnico, 5 bloqueados por decisiones de negocio y 2 no aplicables. F07 está resuelto; N2 y N4 conservan QA funcional pendiente y N3 espera confirmación de Diego. Sprint 2 permanece **NO CERRABLE** hasta resolver esos pendientes. Ver [`CIERRE_TECNICO_SPRINT2_20260813.md`](CIERRE_TECNICO_SPRINT2_20260813.md).
- **Actualización posterior a respuestas de Luis (2026-08-13):** F07, N2 y N4 quedaron autorizados con baselines Bavarian y datos provisionales claramente rotulados. El fault inicial de F07 fue identificado en `Copy_1_of_CreateQuoteLineItem` como FLS faltante sobre dos campos de QLI. El permiso temporal mínimo `Plan_Mantenimiento_QLI_QA` corrigió el acceso y el único reintento v24 terminó `Completed`, creó el Plan `A-0607` y un QLI Regalía PEKING Local/CRC sin duplicado ni rollback. Estado F07: **QA FUNCIONAL OK — PEKING**. N4 está desplegado técnicamente; N2 permanece preparado y N3 sigue pendiente de Diego. Ver [`CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md`](CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md).
...
- **Alcance de Sprint 2 al día de hoy:** usar `CIERRE_TECNICO_SPRINT2_20260813.md` y `CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md` para el estado operativo final. La fila F07 de `MATRIZ_CIERRE_SPRINT2.csv` queda pendiente de sincronización editorial y no prevalece sobre el QA posterior. `REGLAS_ALCANCE_AUTORIZADO.md` conserva la trazabilidad histórica y la puerta obligatoria para cualquier reanudación.
