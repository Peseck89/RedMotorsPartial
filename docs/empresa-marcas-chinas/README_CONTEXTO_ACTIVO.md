...
- **Bloque N2/N3/N4 (actualizado 2026-08-13):** con autorización directa de Luis para usar Bavarian como baseline provisional, `Work_Order_from_Quote` y `Work_Order_from_Quote_Selective` quedaron en v11/v9 con propagación simultánea del lookup `empresaFacturaCP__c` y el código ERP legacy `empresaFactura__c`. El único QA normal se detuvo antes de crear la Work Order porque el usuario funcional no puede leer `Empresa__c.Codigo_ERP__c`; la variante selectiva no se ejecutó. Bodega y territorio siguen **PROVISIONAL / QA / BASADO EN BAVARIAN — NO PRODUCCIÓN**. `SegregateWOLIs`, `aperturaCaseWorOrderEvent` y `ct_newCaseWorkOrderEvent` permanecen bloqueados por decisiones de negocio sin equivalente Bavarian. Ver [`RESULTADO_BLOQUE_N2N3N4_PEKING_20260812.md`](RESULTADO_BLOQUE_N2N3N4_PEKING_20260812.md) y [`CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md`](CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md).
...
- **Cierre técnico conciliado de Sprint 2 (2026-08-13):** los 20 Flows autoritativos quedaron reconciliados sin duplicados: 4 con QA funcional completo, 5 con validación técnica y QA diferido o bloqueado, 6 revisados sin cambio técnico, 3 bloqueados por decisiones de negocio y 2 no aplicables. F07 está resuelto; N2 está bloqueado por FLS, N4 conserva QA funcional pendiente y N3 espera confirmación de Diego. Sprint 2 permanece **NO CERRABLE** hasta resolver esos pendientes. Ver [`CIERRE_TECNICO_SPRINT2_20260813.md`](CIERRE_TECNICO_SPRINT2_20260813.md).
- **Actualización posterior a respuestas de Luis (2026-08-13):** F07, N2 y N4 quedaron autorizados con baselines Bavarian y datos provisionales claramente rotulados. F07 terminó **QA FUNCIONAL OK — PEKING**. N2 tiene la propagación canónica desplegada en v11/v9, pero la única entrevista normal quedó bloqueada por FLS de `Empresa__c.Codigo_ERP__c`; la selectiva no se ejecutó. N4 está desplegado técnicamente y N3 sigue pendiente de Diego. Ver [`CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md`](CIERRE_FUNCIONAL_SPRINT2_POST_RESPUESTA_LUIS_20260813.md).
