...
- **Remediación técnica `Opp_Flow_V5` (2026-08-12):** corregida exclusivamente la ruta Taller mediante una pantalla mínima con lookup estructural de Empresa; la selección específica de Taller tiene precedencia y las demás rutas conservan la selección general. `Opp_Flow_V5` v31 quedó activa en Partial. Validación estructural y deploy correctos; QA funcional manual pendiente. El inventario final mantiene 20 Flows: 8 con validación técnica OK/QA manual pendiente y 0 bloqueados técnicamente. Ver [`RESULTADO_REMEDIACION_OPP_FLOW_V5_TALLER_20260812.md`](RESULTADO_REMEDIACION_OPP_FLOW_V5_TALLER_20260812.md).
