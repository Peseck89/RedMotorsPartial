...
## 44. Validación 33+3 — Next8 Lote 4: registro y consulta de anticipos
...
- La compañía enviada a los servicios de anticipos iniciaba siempre en
  `RMBAVARIAN`.
- Solo cambiaba a `RMOTOBAI` cuando el nombre del Pricebook contenía `Otobai`.
- Opportunity nula, Pricebook nulo o Pricebook desconocido podían caer por
  descarte en `RMBAVARIAN`.
- No existía tratamiento explícito para `RMPEKING`.
...
- Pricebooks Otobai conservan `RMOTOBAI`.
- `RMPEKING` se reconoce explícitamente y se detiene antes del callout porque
  no existe contrato confirmado de anticipos Softland para PEKING.
- Empresa nula, Pricebook desconocido o empresa no soportada producen error
  controlado.
- No existe selección por descarte hacia Bavarian u Otobai.

No se modificaron endpoint, autenticación, payloads fuera de compañía,
creación de `Anticipo__c`, reserva posterior del vehículo, Product2,
OpportunityLineItem, Flows ni LWC.
