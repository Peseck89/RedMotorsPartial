...
import getOpportunityRelatedProducts from '@salesforce/apex/Registrar_Anticipo_Controller.getOpportunityRelatedProductsUsados';
...
export default class Registrar_Anticipo_Select_Vehicle extends NavigationMixin(LightningElement) {
    ...
    handleAcceptClick(event){        
        ...
        let importeMinimo = (this.recordTypeDeveloperName && this.recordTypeDeveloperName == 'Motos_Usados') ? 200 : 500;

        // if(Number(this.amount) >= importeMinimo){
        ...
        //         new ShowToastEvent({
        //             title: 'Error',
        //             message: 'Para aplicar el anticipo es requerido que el monto sea mayor a $ '+importeMinimo+'.',
        //             variant: 'error'
        //         })
        //     );
        // }
