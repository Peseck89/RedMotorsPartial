...
export default class VistaKanbanVahiculoItem extends LightningElement {
    ...
    @wire(getRecords,{ tallerId: "$tallerId", serviceTypeId: "$workServiceType", status: "$stageName", caseNumber: "$caseNumber", workOrderNumber: "$workOrderNumber", vin: "$vin",startDate: "$startCreationDate", endDate: "$endCreationDate", nested:"$nested",objetoStatus:"WorkOrder"})
    ...
    connectedCallback() {
        console.log('tallerId:'+this.tallerId);
        console.log('workServiceType:'+this.workServiceType);
        console.log('stageName:'+this.stageName);
        console.log('workOrderNumber:'+this.workOrderNumber);
        console.log('caseNumber:'+this.caseNumber);
        console.log('vin:'+this.vin);
        console.log('startCreationDate:'+this.startCreationDate);
        console.log('endCreationDate:'+this.endCreationDate);
