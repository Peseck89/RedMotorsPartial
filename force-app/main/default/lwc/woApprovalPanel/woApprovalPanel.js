...
import canView from '@salesforce/apex/WOApprovalPanelCtrl.canView';
...
import COM_FIELD from '@salesforce/schema/WorkOrder.Comentarios_aprobaci_n_centro_de_costos__c';


export default class WoApprovalPanel extends LightningElement {
  @api recordId;
...
get advisorComment() {
  return getFieldValue(this.woRec?.data, COM_FIELD) || '';
}
