...
import getDependentMap from "@salesforce/apex/CT_nuevaCita_controller.getDependentMap";
import getActivity from "@salesforce/apex/CT_nuevaCita_controller.getActives";
import getAsset from "@salesforce/apex/CT_nuevaCita_controller.getAsset";
import updateAccount from "@salesforce/apex/CT_nuevaCita_controller.updateAccount";
import updateContact from "@salesforce/apex/CT_nuevaCita_controller.updateContact";
import { getRecord } from "lightning/uiRecordApi";
import updateContactData from "@salesforce/apex/CT_nuevaCita_controller.updateContactData";
import createContact from "@salesforce/apex/CT_nuevaCita_controller.createContact";
import getDataCalendario from "@salesforce/apex/CT_nuevaCita_controller.getDataCalendario";
import otrosEventos from "@salesforce/apex/CT_nuevaCita_controller.otrosEventos";
import getCalendario from "@salesforce/apex/CT_nuevaCita_controller.getCalendario";
import getAsesores from "@salesforce/apex/CT_nuevaCita_controller.getAsesores";
import LightningAlert from "lightning/alert";
import updateDataAccount from "@salesforce/apex/CT_nuevaCita_controller.updateDataAccount";
import getDataAsesor from "@salesforce/apex/CT_nuevaCita_controller.getDataAsesor";
import getServiceT from "@salesforce/apex/CT_nuevaCita_controller.getServiceT";
import getCedula from "@salesforce/apex/CT_nuevaCita_controller.getCedula";
import createAccount from "@salesforce/apex/CT_nuevaCita_controller.createAccount";
import checkTiempos from "@salesforce/apex/getHorasCitasFlow.checkTiempos";
import actualizarHorarios from "@salesforce/apex/CT_nuevaCita_controller.actualizarHorarios";
import createEvent from "@salesforce/apex/CT_nuevaCita_controller.createEvent";
import getUrlEvent from "@salesforce/apex/CT_nuevaCita_controller.getUrlEvent";
import buscarDuplicado from "@salesforce/apex/CT_nuevaCita_controller.buscarDuplicado";
import getKilometros from "@salesforce/apex/CT_nuevaCita_controller.getKilometros";
import { getObjectInfo } from "lightning/uiObjectInfoApi";
import { getPicklistValues } from "lightning/uiObjectInfoApi";
import CONTACT_OBJECT from "@salesforce/schema/Contact";
import TIPO_DOCUMENTO_FIELD from "@salesforce/schema/Contact.Tipo_de_Documento__c";
import getSeguroDetails from "@salesforce/apex/CT_nuevaCita_controller.getSeguroDetails";
import verifyContactData from "@salesforce/apex/CT_nuevaCita_controller.verifyContactData";
//import getMantenimiento from  '@salesforce/apex/CT_nuevaCita_controller.getMantenimiento';
import USER_ID from "@salesforce/user/Id";
import getCurrentUser from "@salesforce/apex/CT_nuevaCita_controller.getCurrentUser";
import guardarAsset from "@salesforce/apex/CT_nuevaCita_controller.guardarAsset";
import updateEventOrigen from "@salesforce/apex/CT_nuevaCita_controller.updateEventOrigen";
//import getCampaniasByAssetId from "@salesforce/apex/CT_nuevaCita_controller.getCampaniasByAssetId";
//import confirmarCampanias from "@salesforce/apex/CT_nuevaCita_controller.confirmarCampanias";
import obtenerDisponibilidadProximosDias from '@salesforce/apex/CT_nuevaCita_controller.obtenerDisponibilidadProximosDias';
...
export default class CT_nuevaCita_lwc extends LightningElement {
  @api recordId;
  ...
  handleHoraSeleccionada(event) {
      ...
      const offsetStr = `${offsetSign}${String(offsetHours).padStart(2, '0')}:${String(offsetRemainder).padStart(2, '0')}`;
  ...
  async cargarHorariosSugeridos() {
    try {
      ...
      console.log('Horarios sugeridos para garantias:', this.horariosSugeridos);
  ...
  connectedCallback() {
    this.fetchUserInfo();
    console.log('==== Entro Disponibilidad ====');
  ...
  handleChangeCalendario(event) {
    ...
    if (this.calendarioSel == '005Nq00000KfKItIAN') {
      this.mostrarHorariosSugeridos = true;
    } else {
      this.mostrarHorariosSugeridos = false;
    }
  ...
  validaSeleccion() {
    ...
    if (
      ...
      // getCampaniasByAssetId({ assetId: this.assetPlaca })
      // .then((result) => {
      //   this.campanias = result.map((item) => {
      //     return {
      //       ...item,
  ...
  //   }else{
  //     LightningAlert.open({
  //       message: "El chasis debe tener 17 digitos.",
  //       theme: "error",
  //       label: "Error!",
  //     });
  //     return false;
