...
export default class woliGridEditLines extends NavigationMixin(LightningElement)  {
    ...
    connectedCallback() {
        ...
        tempPickList.map(e =>{
            ...
            if (['Mano de Obra', 'Kit'].includes(e.productType)) {
    ...
    @api async handleSave() {
        ...
        const allValid = [
                ...
                if (allValid) {
                    ...
                    saveLines({ jsonString : JSON.stringify(this.modifiedList),workorder:this.recid}) 
                            .then((result) => {
                                console.log(result);
                                /*/this.idOrder=result;
                                //if(!this.handleSave){
