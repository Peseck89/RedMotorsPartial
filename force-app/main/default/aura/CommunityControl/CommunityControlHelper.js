({
  ...
  console.log(day);
  console.log(new Date(startDateHour).toISOString())
  ...
  var action1 = component.get("c.callExternalApiOcupied");
  action1.setParams({
                      ...
                      for (let k = 0; k < mapaEventoDia.length; k++) {
                        ...
                        for (let j = 0; j < result.length; j++) {     
                          var time1 = key;
                            ...
                            // console.log('**************************************************************');
                            // console.log(normalizedTime1);
                            // console.log(normalizedTime2);
