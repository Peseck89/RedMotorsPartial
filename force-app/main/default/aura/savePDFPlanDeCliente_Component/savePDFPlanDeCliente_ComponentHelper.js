    ...
    */
    ...
    handleAttachPDF : function(component, event, helper){
        ...
        action.setParams({
            ...
            "vfNamePage" : 'cT_newPlanCliente?Id=' + component.get('v.recordId'),
            "save" : true
        });
        action.setCallback(this, function(response){
            let state = response.getState();
            ...
            if(state === "SUCCESS"){
                ...
                console.log(component.get('v.instanceURL') + '/apex/cT_newPlanCliente?Id=' + component.get('v.recordId'));
                var urlEvent = $A.get("e.force:navigateToURL");
                urlEvent.setParams({
                    "url" : component.get('v.instanceURL') + '/apex/cT_newPlanCliente?Id=' + component.get('v.recordId')
                });
                urlEvent.fire();
            }
            else{
