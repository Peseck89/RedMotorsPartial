({
    ...
    changeFamilia: function(component, event, helper) {
        ...
        // console.log(familiaSeleccionado);
        ...
        createTrafico.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if (sucursalBuscar == 'Escazú') {
                    window.location.replace('/walking/s/gracias?sucursal=Escazu');
                } else {
                    window.location.replace('/walking/s/gracias?sucursal='+sucursalBuscar);
                }
            }else{
                console.log(state);
                component.set("v.isLoading", false);
    ...
    returnHome : function(component, event, helper) {
        window.location.replace('/walking/s/')
    },
