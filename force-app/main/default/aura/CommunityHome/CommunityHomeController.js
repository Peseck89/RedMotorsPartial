({
  doInit: function (component, event, helper) {
    ...
    // var videoPrueba = "https://drive.google.com/uc?export=download&id=1UBLhcS-BDgbOEz1cmFqjm50eV9_buSgD"
    var videoPrueba = "https://redmotors.file.force.com/sfc/dist/version/download/?oid=00D0P000000Dvkz&ids=068PH00000OUUnd&d=%2Fa%2FPH000000vylq%2F98uEwGxWDFOudooKqiu38MX.uOZQPCMx3ZLCFM.b1RM&asPdf=false"
    component.set("v.videoUrl", videoPrueba)
  ...
  handleOnChangeSelectedMarca: function (component, event, helper) {
    ...
    if (marcaSelected != marcaUrlAnt) {
      window.location.replace("/s/?servicio=" + marcaSelected);
      // window.location.replace('https://redmotors.my.site.com/s/?servicio=' + marcaSelected )
    }
